...
RSpec.describe 'contributor translation maps are valid' do # rubocop:disable RSpec/DescribeClass this tests config consistency, not a class
  ...
  it_behaves_like 'a valid translation map chain', 'lib/translation_maps/agg_collection_ar_from_en.yaml', ['lib/translation_maps/agg_collection_from_provider.yaml']
