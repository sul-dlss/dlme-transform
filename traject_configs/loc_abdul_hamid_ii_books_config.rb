...
to_field 'agg_data_provider_collection', literal('loc-abdul-hamid-books'), translation_map('agg_collection_from_provider_id'), lang('en')
to_field 'agg_data_provider_collection', literal('loc-abdul-hamid-books'), translation_map('agg_collection_from_provider_id'), translation_map('agg_collection_ar_from_en'), lang('ar-Arab')
to_field 'agg_data_provider_collection_id', literal('loc-abdul-hamid-books')
...
to_field 'cho_title', extract_json('.item.title'), strip, arabic_script_lang_or_default('ar-Arab', 'und-Latn')
