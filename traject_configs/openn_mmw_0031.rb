...
to_field 'agg_data_provider_collection', literal('openn-mmw-31'), translation_map('agg_collection_from_provider_id'), lang('en')
to_field 'agg_data_provider_collection', literal('openn-mmw-31'), translation_map('agg_collection_from_provider_id'), translation_map('agg_collection_ar_from_en'), lang('ar-Arab')
to_field 'agg_data_provider_collection_id', literal('openn-mmw-31')
...
to_field 'cho_title', extract_tei("#{MS_DESC}/#{MS_CONTENTS}/#{MS_ITEM}[1]/tei:title[1]"), strip, split('/'), first_only, strip, lang('en')
to_field 'cho_title', extract_tei("#{MS_DESC}/#{MS_CONTENTS}/#{MS_ITEM}[1]/tei:title[1]"), strip, split('/'), last, strip, lang('ar-Arab')
