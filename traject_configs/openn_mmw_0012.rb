...
to_field 'agg_data_provider_collection', literal('openn-mmw-12'), translation_map('agg_collection_from_provider_id'), lang('en')
to_field 'agg_data_provider_collection', literal('openn-mmw-12'), translation_map('agg_collection_from_provider_id'), translation_map('agg_collection_ar_from_en'), lang('ar-Arab')
to_field 'agg_data_provider_collection_id', literal('openn-mmw-12')
...
to_field 'cho_title', extract_tei("#{MS_DESC}/#{MS_CONTENTS}/#{MS_ITEM}[1]/tei:title[1]"), split('/'), first_only, strip, lang('ar-Latn')
to_field 'cho_title', extract_tei("#{MS_DESC}/#{MS_CONTENTS}/#{MS_ITEM}[1]/tei:title[1]"), split('/'), last, strip, lang('ar-Arab')

# CHO Other
to_field 'cho_creator', extract_tei("#{MS_DESC}/#{MS_CONTENTS}/#{MS_ITEM}/tei:author[1]"), split('/'), first_only, strip, lang('ar-Latn')
to_field 'cho_creator', extract_tei("#{MS_DESC}/#{MS_CONTENTS}/#{MS_ITEM}/tei:author[1]"), split('/'), last, strip, lang('ar-Arab')
