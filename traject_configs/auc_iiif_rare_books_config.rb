...
to_field 'agg_data_provider_collection', literal('auc-rare-books'), translation_map('agg_collection_from_provider_id'), lang('en')
to_field 'agg_data_provider_collection', literal('auc-rare-books'), translation_map('agg_collection_from_provider_id'), translation_map('agg_collection_ar_from_en'), lang('ar-Arab')
to_field 'agg_data_provider_collection_id', literal('auc-rare-books')
...
to_field 'cho_title', extract_json('.alternative-title'), strip, arabic_script_lang_or_default('ar-Arab', 'und-Latn')
...
to_field 'cho_language', extract_json('.language'), split(';'), strip, normalize_language, translation_map('lang_ar_from_en'), lang('ar-Arab')
