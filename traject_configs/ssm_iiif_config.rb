...
to_field 'agg_data_provider_collection_id', extract_json('.manifest'), gsub('https://cdm21044.contentdm.oclc.org/iiif/info/', ''), split('/'), first_only, transform(&:downcase), prepend('ssm-'), strip
