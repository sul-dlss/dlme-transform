...
to_field 'cho_description', extract_json('.illuminations'), strip, prepend('Illuminations: ')
to_field 'cho_description', extract_json('.illustrations'), strip, prepend('Illustrations: ')
