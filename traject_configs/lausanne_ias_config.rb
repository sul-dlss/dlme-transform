...
to_field 'cho_edm_type', column('document_type_id'), translation_map('has_type_from_lausanne'), translation_map('edm_type_from_has_type'), lang('en')
to_field 'cho_edm_type', column('document_type_id'), translation_map('has_type_from_lausanne'), translation_map('edm_type_from_has_type'), translation_map('edm_type_ar_from_en'), lang('ar-Arab')
