...
# Cho Required
to_field 'id', column('id'), parse_csv, strip, split(':'), at_index(-1), strip
...
to_field 'cho_edm_type', column('type'), parse_csv, strip, normalize_has_type, normalize_edm_type, translation_map('has_type_ar_from_en'), lang('ar-Arab')
