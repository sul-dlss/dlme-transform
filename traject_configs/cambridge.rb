...
to_field 'cho_description', column('binding'), parse_csv, strip, prepend('Binding: '), arabic_script_lang_or_default('ar-Arab', 'en')
to_field 'cho_description', column('decoration'), parse_csv, strip, prepend('Decoration: '), arabic_script_lang_or_default('ar-Arab', 'en')
to_field 'cho_description', column('description'), parse_csv, split('/'), strip, arabic_script_lang_or_default('ar-Arab', 'en')
to_field 'cho_description', column('foliation'), parse_csv, strip, prepend('Foliation: '), arabic_script_lang_or_default('ar-Arab', 'en')
...
to_field 'cho_description', column('recipients'), parse_csv, strip, prepend('Recipients: '), arabic_script_lang_or_default('ar-Arab', 'en')
...
to_field 'cho_dc_rights', column('attribution'), parse_csv, strip, lang('fr')
to_field 'cho_dc_rights', column('attribution'), parse_csv, strip, lang('en')
to_field 'cho_edm_type', literal('Text'), lang('en')
to_field 'cho_edm_type', literal('Text'), translation_map('edm_type_ar_from_en'), lang('ar-Arab')
to_field 'cho_format', column('extent'), parse_csv, strip, lang('fr')
...
to_field 'cho_language', column('languages'), parse_csv,  strip, split(','), normalize_language, lang('en')
to_field 'cho_language', column('languages'), parse_csv,  strip, split(','), normalize_language, translation_map('lang_ar_from_en'), lang('ar-Arab')
