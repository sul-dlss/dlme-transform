...
to_field 'agg_data_provider_collection', literal('auc-bint-alnil'), translation_map('agg_collection_from_provider_id'), lang('en')
to_field 'agg_data_provider_collection', literal('auc-bint-alnil'), translation_map('agg_collection_from_provider_id'), translation_map('agg_collection_ar_from_en'), lang('ar-Arab')
to_field 'agg_data_provider_collection_id', literal('auc-bint-alnil')
...
to_field 'cho_title', extract_json('.title-arabic'), strip, gsub('Alternative Title ', ''), lang('ar-Arab')
to_field 'cho_title', extract_json('.title-english'), strip, lang('en')
...
to_field 'cho_description', extract_json('.description-arabic'), strip, lang('ar-Arab')
to_field 'cho_description', extract_json('.description-english'), strip, lang('en')
