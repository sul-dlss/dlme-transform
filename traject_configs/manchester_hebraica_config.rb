...
to_field 'cho_language', extract_oai('dc:language'), strip, normalize_language, lang('en')
to_field 'cho_language', extract_oai('dc:language'), strip, normalize_language, translation_map('norm_languages_to_ar'), lang('ar-Arab')
