...
to_field 'agg_data_provider_collection', literal('auc-historical-videos'), translation_map('agg_collection_from_provider_id'), lang('en')
to_field 'agg_data_provider_collection', literal('auc-historical-videos'), translation_map('agg_collection_from_provider_id'), translation_map('agg_collection_ar_from_en'), lang('ar-Arab')
to_field 'agg_data_provider_collection_id', literal('auc-historical-videos')
...
to_field 'cho_edm_type', literal('Video'), lang('en')
to_field 'cho_edm_type', literal('Video'), translation_map('edm_type_ar_from_en'), lang('ar-Arab')
to_field 'cho_format', extract_oai('dc:format'), strip, lang('en')
to_field 'cho_has_type', literal('Historical Videos'), lang('en')
to_field 'cho_has_type', literal('Historical Videos'), translation_map('has_type_ar_from_en'), lang('ar-Arab')
