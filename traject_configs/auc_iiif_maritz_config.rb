...
to_field 'agg_data_provider_collection', literal('auc-maritz'), translation_map('agg_collection_from_provider_id'), lang('en')
to_field 'agg_data_provider_collection', literal('auc-maritz'), translation_map('agg_collection_from_provider_id'), translation_map('agg_collection_ar_from_en'), lang('ar-Arab')
to_field 'agg_data_provider_collection_id', literal('auc-maritz')
...
to_field 'cho_title', extract_json('.alternative-title'), strip, lang('en')
to_field 'cho_title', extract_json('.title'), strip, lang('fr')

# Cho Other
to_field 'cho_creator', extract_json('.photographer'),
         strip, prepend('Photographer: '), lang('en')
...
to_field 'cho_type', extract_json('.getty-aat'), strip, lang('en')
