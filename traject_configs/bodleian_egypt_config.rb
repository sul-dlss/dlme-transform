...
to_field 'agg_data_provider_collection', literal('bodleian-egypt'), translation_map('agg_collection_from_provider_id'), lang('en')
to_field 'agg_data_provider_collection', literal('bodleian-egypt'), translation_map('agg_collection_from_provider_id'), translation_map('agg_collection_ar_from_en'), lang('ar-Arab')
to_field 'agg_data_provider_collection_id', literal('bodleian-egypt')

# Cho Required
to_field 'id', column('rendering'),
         strip,
         gsub('https://digital.bodleian.ox.ac.uk/inquire/p/', '')
to_field 'cho_title', column('title'), strip, lang('und-Latn')
...
to_field 'cho_language', column('language'), strip, normalize_language, lang('en')
to_field 'cho_language', column('language'), strip, normalize_language, translation_map('lang_ar_from_en'), lang('ar-Arab')
