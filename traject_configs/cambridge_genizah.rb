...
to_field 'agg_data_provider_collection', literal('cambridge-genizah'), translation_map('agg_collection_from_provider_id'), lang('en')
to_field 'agg_data_provider_collection', literal('cambridge-genizah'), translation_map('agg_collection_from_provider_id'), translation_map('agg_collection_ar_from_en'), lang('ar-Arab')
to_field 'agg_data_provider_collection_id', literal('cambridge-genizah')
...
to_field 'cho_title', xpath_common_title_or_desc("#{MS_DESC}/#{MS_CONTENTS}/#{MS_ITEM}/tei:title[1]", "#{MS_DESC}/#{MS_CONTENTS}/tei:summary[1]", "#{MS_DESC}/#{MS_ID}/tei:idno"), gsub('T-S AS', ''), squish, lang('en'), default('Untitled', 'بدون عنوان')

# Cho other
to_field 'cho_creator', extract_tei("#{MS_DESC}/#{MS_CONTENTS}/#{MS_ITEM}/tei:author/tei:name/tei:persName[@type='standard']"), strip, lang('en')
...
to_field 'cho_is_part_of', literal('The Taylor-Schechter Genizah Collection'), lang('en')
...
to_field 'agg_is_shown_at' do |_record, accumulator, context|
  accumulator << transform_values(context,
                                  ...
                                  'wr_edm_rights' => [literal('InC-EDU'), translation_map('edm_rights_from_contributor')],
