...
to_field 'cho_title', extract_json('.title'), flatten_array, dlme_strip, arabic_script_lang_or_default('ar-Arab', 'en')
to_field 'cho_title', extract_json('.uniform-title'), flatten_array, dlme_strip, arabic_script_lang_or_default('ar-Arab', 'en')
to_field 'cho_title', extract_json('.descriptive-titles'), flatten_array, dlme_strip, arabic_script_lang_or_default('ar-Arab', 'en')
...
to_field 'cho_description', extract_json('.description'), flatten_array, dlme_split('/'), dlme_strip, arabic_script_lang_or_default('ar-Arab', 'en')
to_field 'cho_description', extract_json('.material'), flatten_array, dlme_strip, dlme_prepend('Material: '), arabic_script_lang_or_default('ar-Arab', 'en')
to_field 'cho_description', extract_json('.notes'), flatten_array, dlme_strip, dlme_prepend('Notes: '), arabic_script_lang_or_default('ar-Arab', 'en')
to_field 'cho_description', extract_json('.script'), flatten_array, dlme_strip, dlme_prepend('Script: '), arabic_script_lang_or_default('ar-Arab', 'en')
to_field 'cho_description', extract_json('.layout'), flatten_array, dlme_strip, dlme_prepend('Layout: '), arabic_script_lang_or_default('ar-Arab', 'en')
...
to_field 'cho_identifier', extract_json('.classmark'), flatten_array, dlme_strip
