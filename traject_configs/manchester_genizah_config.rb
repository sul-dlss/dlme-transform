...
to_field 'cho_language', extract_oai('dc:language'), strip, gsub('?', ''), normalize_language, lang('en')
to_field 'cho_language', extract_oai('dc:language'), strip, gsub('?', ''), normalize_language, translation_map('norm_languages_to_ar'), lang('ar-Arab')
