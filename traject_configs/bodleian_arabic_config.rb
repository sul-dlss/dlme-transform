...
to_field 'cho_title', get_arabic_title('title')
to_field 'cho_title', get_arabic_title('other_titles')

# Cho Other
to_field 'cho_creator', extract_json('.author'), strip, lang('und-Latn')
...
to_field 'cho_spatial', extract_json('.place_of_origin'), strip
