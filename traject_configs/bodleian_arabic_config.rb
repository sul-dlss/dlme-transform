...
to_field 'agg_data_provider_collection', literal('bodleian-arabic'), translation_map('agg_collection_from_provider_id'), lang('en')
to_field 'agg_data_provider_collection', literal('bodleian-arabic'), translation_map('agg_collection_from_provider_id'), translation_map('agg_collection_ar_from_en'), lang('ar-Arab')
to_field 'agg_data_provider_collection_id', literal('bodleian-arabic')
...
to_field 'cho_title', column('title'), split(' ('), gsub(')', ''), gsub('(', ''), strip, arabic_script_lang_or_default('ar-Arab', 'und-Latn')

# Cho Other
to_field 'cho_creator', column('author'), strip, lang('en')
to_field 'cho_contributor', column('editors'), strip, prepend('Editor: '), lang('en')
to_field 'cho_contributor', column('scribe'), strip, prepend('Scribe: '), lang('en')
to_field 'cho_contributor', column('annotator'), strip, prepend('Annotator: '), lang('en')
