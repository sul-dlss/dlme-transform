...
to_field 'agg_data_provider_collection', literal('auc-coptic'), translation_map('agg_collection_from_provider_id'), lang('en')
to_field 'agg_data_provider_collection', literal('auc-coptic'), translation_map('agg_collection_from_provider_id'), translation_map('agg_collection_ar_from_en'), lang('ar-Arab')
to_field 'agg_data_provider_collection_id', literal('auc-coptic')
...
# Cho Other
to_field 'cho_creator', extract_json('.author'), strip, prepend('Author: '), lang('en')
...
to_field 'cho_description', extract_json('.scribe'), strip, prepend('Scribe: '), lang('en')
...
to_field 'cho_provenance', extract_json('.patron'), strip, prepend('Previous Owner: '), lang('en')
