...
# CHO Other
to_field 'cho_contributor', column('Issuer'), split('|'), strip, lang('en')
to_field 'cho_contributor', column('Engraver'), split('|'), strip, lang('en')
...
to_field 'cho_spatial', column('Locality'), strip, lang('en')
