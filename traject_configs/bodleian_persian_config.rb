...
to_field 'cho_title', extract_json('.title'), split('('), first_only, strip, arabic_script_lang_or_default('fa-Arab', 'und-Latn')
to_field 'cho_title', extract_json('.other_titles'), strip, arabic_script_lang_or_default('fa-Arab', 'und-Latn')
