...
to_field 'agg_data_provider_collection', literal('auc-student-news'), translation_map('agg_collection_from_provider_id'), lang('en')
to_field 'agg_data_provider_collection', literal('auc-student-news'), translation_map('agg_collection_from_provider_id'), translation_map('agg_collection_ar_from_en'), lang('ar-Arab')
to_field 'agg_data_provider_collection_id', literal('auc-student-news')
...
to_field 'cho_spatial', extract_json('.coverage'), strip, lang('en')
to_field 'cho_subject', extract_json('.subject'), strip, lang('en')
to_field 'cho_type', extract_json('.type'), strip, lang('en')
to_field 'cho_type', extract_json('.genre'), strip, lang('en')
...
to_field 'agg_is_shown_at' do |_record, accumulator, context|
  accumulator << transform_values(
    context,
    'wr_dc_rights' => [extract_json('.access'), strip],
