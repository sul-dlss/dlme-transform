...
to_field 'agg_data_provider_collection', literal('bodleian-hebrew'), translation_map('agg_collection_from_provider_id'), lang('en')
to_field 'agg_data_provider_collection', literal('bodleian-hebrew'), translation_map('agg_collection_from_provider_id'), translation_map('agg_collection_ar_from_en'), lang('ar-Arab')
to_field 'agg_data_provider_collection_id', literal('bodleian-hebrew')
...
to_field 'cho_title', column('title'), split(' ('), gsub(')', ''), gsub('(', ''), strip, hebrew_script_lang_or_default('he', 'und-Latn')
...
to_field 'cho_language', literal('Hebrew'), translation_map('lang_ar_from_en'), lang('ar-Arab')
to_field 'cho_medium', column('materials'), strip, lang('en')
to_field 'cho_spatial', column('place_of_origin'), strip, gsub('[', ''), gsub(']', ''), lang('en')
