...
to_field 'cho_title', extract_json('.title'), strip, strip, arabic_script_lang_or_default('und-Arab', 'und-Latn')
to_field 'cho_title', extract_json('.other_titles'), strip, arabic_script_lang_or_default('und-Arab', 'und-Latn')
