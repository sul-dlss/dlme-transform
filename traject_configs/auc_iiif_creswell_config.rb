...
to_field 'agg_data_provider_collection', literal('auc-creswell'), translation_map('agg_collection_from_provider_id'), lang('en')
to_field 'agg_data_provider_collection', literal('auc-creswell'), translation_map('agg_collection_from_provider_id'), translation_map('agg_collection_ar_from_en'), lang('ar-Arab')
to_field 'agg_data_provider_collection_id', literal('auc-creswell')
...
to_field 'cho_subject', extract_json('.topic'), strip, lang('en')
