...
to_field 'cho_description', extract_json('.Inscriptions'), prepend('Inscriptions: '), lang('en')
to_field 'cho_description', extract_json('.Reign'), prepend('Regin: '), lang('en')
to_field 'cho_description', extract_json('.Style'), prepend('Style: '), lang('en')
