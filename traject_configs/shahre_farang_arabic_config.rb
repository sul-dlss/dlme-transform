...
to_field 'cho_subject', extract_json('.tags[3].term'), strip, lang('ar-Arab')
to_field 'cho_subject', extract_json('.tags[4].term'), strip, lang('ar-Arab')
to_field 'cho_subject', extract_json('.tags[5].term'), strip, lang('ar-Arab')
to_field 'cho_subject', extract_json('.tags[6].term'), strip, lang('ar-Arab')
to_field 'cho_subject', extract_json('.tags[7].term'), strip, lang('ar-Arab')
