...
to_field 'agg_data_provider_collection', literal('openn-genizah'), translation_map('agg_collection_from_provider_id'), lang('en')
to_field 'agg_data_provider_collection', literal('openn-genizah'), translation_map('agg_collection_from_provider_id'), translation_map('agg_collection_ar_from_en'), lang('ar-Arab')
to_field 'agg_data_provider_collection_id', literal('openn-genizah')
...
to_field 'cho_is_part_of', literal('OPenn: Cairo Genizah'), lang('en')
...
to_field 'cho_subject', literal('Cairo Genizah'), lang('en')
