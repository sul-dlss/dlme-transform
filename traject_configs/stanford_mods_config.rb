...
to_field 'cho_language', normalize_mods_language, translation_map('marc_languages'), lang('en')
to_field 'cho_language', normalize_mods_language, translation_map('marc_languages'), translation_map('norm_languages_to_ar'), lang('ar-Arab')
