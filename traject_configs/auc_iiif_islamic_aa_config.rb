...
to_field 'agg_data_provider_collection', literal('auc-islamic-aa'), translation_map('agg_collection_from_provider_id'), lang('en')
to_field 'agg_data_provider_collection', literal('auc-islamic-aa'), translation_map('agg_collection_from_provider_id'), translation_map('agg_collection_ar_from_en'), lang('ar-Arab')
to_field 'agg_data_provider_collection_id', literal('auc-islamic-aa')
...
# Cho Other
to_field 'cho_date', extract_json('.date-built'), strip, prepend('Date Built: '), lang('en')
to_field 'cho_date_range_hijri', extract_json('.date-built'), strip, auc_date_range, hijri_range
to_field 'cho_date_range_norm', extract_json('.date-built'), strip, auc_date_range
to_field 'cho_dc_rights', extract_json('.license'), strip, lang('en')
to_field 'cho_description', extract_json('.description'), strip, lang('en')
to_field 'cho_description', extract_json('.site'), prepend('Site: '), strip, lang('en')
...
to_field 'cho_subject', extract_json('.subject-tgm'), strip, lang('en')
