...
to_field 'cho_edm_type', extract_json('..genre'), flatten_array, dlme_strip, dlme_split(';'), dlme_strip, normalize_has_type, normalize_edm_type, lang('en')
to_field 'cho_edm_type', extract_json('..genre'), flatten_array, dlme_strip, dlme_split(';'), dlme_strip, normalize_has_type, normalize_edm_type, translation_map('edm_type_ar_from_en'), lang('ar-Arab')
to_field 'cho_edm_type', extract_json('..genre-aat'), flatten_array, dlme_strip, dlme_split(';'), dlme_strip, normalize_has_type, normalize_edm_type, lang('en')
to_field 'cho_edm_type', extract_json('..genre-aat'), flatten_array, dlme_strip, dlme_split(';'), dlme_strip, normalize_has_type, normalize_edm_type, translation_map('edm_type_ar_from_en'), lang('ar-Arab')
to_field 'cho_edm_type', extract_json('..getty-aat'), flatten_array, dlme_strip, dlme_split(';'), dlme_strip, normalize_has_type, normalize_edm_type, lang('en')
to_field 'cho_edm_type', extract_json('..getty-aat'), flatten_array, dlme_strip, dlme_split(';'), dlme_strip, normalize_has_type, normalize_edm_type, translation_map('edm_type_ar_from_en'), lang('ar-Arab')
to_field 'cho_edm_type', extract_json('..type'), flatten_array, dlme_strip, dlme_split(';'), dlme_strip, normalize_has_type, normalize_edm_type, lang('en')
to_field 'cho_edm_type', extract_json('..type'), flatten_array, dlme_strip, dlme_split(';'), dlme_strip, normalize_has_type, normalize_edm_type, translation_map('edm_type_ar_from_en'), lang('ar-Arab')
to_field 'cho_edm_type', path_to_file, dlme_split('/'), at_index(-2), dlme_gsub('_', '-'), dlme_prepend('auc-'), dlme_strip, dlme_split(';'), dlme_strip, normalize_has_type, normalize_edm_type, lang('en')
to_field 'cho_edm_type', path_to_file, dlme_split('/'), at_index(-2), dlme_gsub('_', '-'), dlme_prepend('auc-'), dlme_strip, dlme_split(';'), dlme_strip, normalize_has_type, normalize_edm_type, translation_map('edm_type_ar_from_en'), lang('ar-Arab')
...
to_field 'cho_has_type', path_to_file, dlme_split('/'), at_index(-2), dlme_gsub('_', '-'), dlme_prepend('auc-'), dlme_strip, dlme_split(';'), dlme_strip, normalize_has_type, lang('en')
to_field 'cho_has_type', path_to_file, dlme_split('/'), at_index(-2), dlme_gsub('_', '-'), dlme_prepend('auc-'), dlme_strip, dlme_split(';'), dlme_strip, normalize_has_type, translation_map('has_type_ar_from_en'), lang('ar-Arab')
to_field 'cho_has_type', extract_json('..genre'), flatten_array, dlme_strip, dlme_split(';'), dlme_strip, normalize_has_type, lang('en')
to_field 'cho_has_type', extract_json('..genre'), flatten_array, dlme_strip, dlme_split(';'), dlme_strip, normalize_has_type, translation_map('has_type_ar_from_en'), lang('ar-Arab')
to_field 'cho_has_type', extract_json('..getty-aat'), flatten_array, dlme_strip, dlme_split(';'), dlme_strip, normalize_has_type, lang('en')
to_field 'cho_has_type', extract_json('..getty-aat'), flatten_array, dlme_strip, dlme_split(';'), dlme_strip, normalize_has_type, translation_map('has_type_ar_from_en'), lang('ar-Arab')
to_field 'cho_has_type', extract_json('..physical-format'), flatten_array, dlme_strip, dlme_split(';'), dlme_strip, normalize_has_type, lang('en')
to_field 'cho_has_type', extract_json('..physical-format'), flatten_array, dlme_strip, dlme_split(';'), dlme_strip, normalize_has_type, translation_map('has_type_ar_from_en'), lang('ar-Arab')
to_field 'cho_has_type', extract_json('..type'), flatten_array, dlme_strip, dlme_split(';'), dlme_strip, normalize_has_type, lang('en')
to_field 'cho_has_type', extract_json('..type'), flatten_array, dlme_strip, dlme_split(';'), dlme_strip, normalize_has_type, translation_map('has_type_ar_from_en'), lang('ar-Arab')
to_field 'cho_has_type', extract_json('..type-dcmi'), flatten_array, dlme_strip, dlme_split(';'), dlme_strip, normalize_has_type, lang('en')
to_field 'cho_has_type', extract_json('..type-dcmi'), flatten_array, dlme_strip, dlme_split(';'), dlme_strip, normalize_has_type, translation_map('has_type_ar_from_en'), lang('ar-Arab')
to_field 'cho_has_type', extract_json('..worktype'), flatten_array, dlme_strip, dlme_split(';'), dlme_strip, normalize_has_type, lang('en')
to_field 'cho_has_type', extract_json('..worktype'), flatten_array, dlme_strip, dlme_split(';'), dlme_strip, normalize_has_type, translation_map('has_type_ar_from_en'), lang('ar-Arab')
to_field 'cho_has_type', extract_json('..worktype-of-printed-material'), flatten_array, dlme_strip, dlme_split(';'), dlme_strip, normalize_has_type, lang('en')
to_field 'cho_has_type', extract_json('..worktype-of-printed-material'), flatten_array, dlme_strip, dlme_split(';'), dlme_strip, normalize_has_type, translation_map('has_type_ar_from_en'), lang('ar-Arab')
