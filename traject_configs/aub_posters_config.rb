...
to_field 'agg_data_provider_collection', literal('aub-posters'), translation_map('agg_collection_from_provider_id'), lang('en')
to_field 'agg_data_provider_collection', literal('aub-posters'), translation_map('agg_collection_from_provider_id'), translation_map('agg_collection_ar_from_en'), lang('ar-Arab')
to_field 'agg_data_provider_collection_id', literal('aub-posters')
...
to_field 'cho_title', extract_oai('dc:title'), strip, arabic_script_lang_or_default('ar-Arab', 'en')

# Cho Other
to_field 'cho_contributor', extract_oai('dc:contributor'),
         strip, split('.'), arabic_script_lang_or_default('ar-Arab', 'en')
...
to_field 'cho_subject', extract_oai('dc:subject'), strip, arabic_script_lang_or_default('ar-Arab', 'en')
