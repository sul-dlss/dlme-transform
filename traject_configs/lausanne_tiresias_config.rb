...
to_field 'cho_description', column('Description'), gsub('/<em>', ''), gsub('</em>', ''), lang('fr')
...
to_field 'cho_spatial', column('Pays de découverte'), lang('fr')
to_field 'cho_spatial', column('Site/Lieu de découverte'), lang('fr')
to_field 'cho_temporal', clumn('Période'), lang('en')
