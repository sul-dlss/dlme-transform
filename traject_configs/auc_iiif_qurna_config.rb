...
to_field 'agg_data_provider_collection', literal('auc-qurna'), translation_map('agg_collection_from_provider_id'), lang('en')
to_field 'agg_data_provider_collection', literal('auc-qurna'), translation_map('agg_collection_from_provider_id'), translation_map('agg_collection_ar_from_en'), lang('ar-Arab')
to_field 'agg_data_provider_collection_id', literal('auc-qurna')
...
# Cho Other
to_field 'cho_creator', extract_json('.interviewee'), prepend('Interviewee: '), strip, lang('en')
...
to_field 'cho_is_part_of', literal('Qurna Hillside Oral History Project'), lang('en')
