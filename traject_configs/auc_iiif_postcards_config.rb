...
to_field 'agg_data_provider_collection', literal('auc-postcards'), translation_map('agg_collection_from_provider_id'), lang('en')
to_field 'agg_data_provider_collection', literal('auc-postcards'), translation_map('agg_collection_from_provider_id'), translation_map('agg_collection_ar_from_en'), lang('ar-Arab')
to_field 'agg_data_provider_collection_id', literal('auc-postcards')

# Cho Required
to_field 'id', extract_json('.id'), strip, gsub('/manifest.json', ''), gsub('https://cdm15795.contentdm.oclc.org/iiif/info/', '')
to_field 'cho_title', extract_json('.title'), strip, gsub('&quot;', '"'), lang('und-Latn')

# Cho Other
to_field 'cho_alternative', extract_json('.alternative-title'), strip, lang('und-Latn')
...
to_field 'cho_description', extract_json('.site'), strip, prepend('Site: '), lang('en')
...
to_field 'cho_subject', extract_json('.subject-getty-aat'), strip, lang('en')
